...
contract IntelliLinker is AccessControl {
	 ...
	 */
	constructor(address _ali, address _personality, address _iNft) AccessControl(msg.sender, 0) {
	...
	function link(uint96 personalityId, address targetContract, uint256 targetId) public {
		...
		require(
			whitelistedTargetContracts[targetContract] || isFeatureEnabled(FEATURE_ALLOW_ANY_NFT_CONTRACT),
