# AI Protocol Intelligent Token Linker #
 iNFT Linker is a helper smart contract responsible for managing iNFTs. It creates and destroys iNFTs, determines iNFT creation price and destruction fee.
...
1. Clone the repository  
    ```git clone git@github.com:AI-Protocol-Official/intelli-linker-contracts.git```
2. Navigate into the cloned repository  
    ```cd intelli-linker-contracts```
